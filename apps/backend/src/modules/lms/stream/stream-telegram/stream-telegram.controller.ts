...
import { IStreamController } from "./stream-telegram.types";
import { StreamTelegramService } from "./stream-telegram.service";
import { bindStreamTelegramPayloadSchema, idParamSchema } from "@repo/schemas";

export class StreamTelegramController implements IStreamController {
